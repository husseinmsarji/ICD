...
can evolve without touching the core library. Validation here is loose by
design; the XSD/jsonschema in icdgen.loader is authoritative. busType is
freeform, signalType may be blank, and numeric signal fields are optional,
so a partially-complete ICD round-trips through the API.
"""
